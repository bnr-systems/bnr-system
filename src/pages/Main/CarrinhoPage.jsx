...
const CarrinhoPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 md:p-10 bg-white rounded-2xl shadow-lg mt-10">
      <div className="mb-8 text-center">
        <div className="mt-4">
          <button
            onClick={() => navigate("/pecas")}
            className="flex items-center justify-start text-blue-600 hover:text-blue-800 font-medium transition-colors gap-1"
          >
            <ArrowLeft size={18} />
            Voltar 
          </button>
        ...
        <>
              ...
              <tbody className="divide-y divide-gray-200">
                {carrinho.map((peca) => (
                  <tr key={peca.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-gray-600">{peca.codigo}</td>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 mt-6">
            <button
              ...
              className="px-5 py-2 text-gray-600 border border-gray-300 rounded-full hover:bg-gray-100 transition-colors"
            >
              Limpar Carrinho
            </button>
            <button
              ...
              disabled={isLoading}
              className={`px-6 py-3 bg-green-600 text-white rounded-full font-semibold shadow-md hover:bg-green-700 transition-all flex items-center gap-2 ${
